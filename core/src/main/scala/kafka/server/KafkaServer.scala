  ...
  def startup(): Unit = {
    try {
      ...
      if (canStartup) {
        ...
        // 启动SocketServer，启动Acceptor和Processor和线程
        ...
        //处理数据面板请求队列的请求--这是个线程数为8的线程池。共享dataPlaneRequestChannel的请求队列
        ...
        // 启动Data plane 和 Control plane的所有线程
